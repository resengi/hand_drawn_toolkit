...
void main() {
  ...
  group('HandDrawnTable copyWith', () {
    test('round-trips and overrides', () {
      const original = HandDrawnTable(
        columns: _columns,
        rows: _rows,
        title: 'Original',
        seed: 7,
      ...
      expect(copy.columns, original.columns);
      expect(copy.rows, original.rows);
      expect(copy.title, original.title);
      expect(copy.highlightColor, original.highlightColor);
      expect(copy.highlightAlpha, original.highlightAlpha);
      expect(copy.headerStyle, original.headerStyle);
      expect(copy.cellStyle, original.cellStyle);
      ...
      expect(copy.rowDividers, original.rowDividers);
      expect(copy.columnDividers, original.columnDividers);
      expect(copy.padding, original.padding);
      expect(copy.rowPadding, original.rowPadding);
      expect(copy.titleBottomPadding, original.titleBottomPadding);
      expect(copy.textOverflow, original.textOverflow);
      expect(copy.cellMaxLines, original.cellMaxLines);
      expect(copy.softWrap, original.softWrap);
      expect(copy.horizontalScroll, original.horizontalScroll);
      ...
      final retitled = original.copyWith(title: 'Renamed');
      expect(retitled.title, 'Renamed');
      expect(retitled.columns, original.columns);
      expect(retitled.rows, original.rows);
      expect(retitled.seed, original.seed);
      expect(retitled.horizontalScroll, original.horizontalScroll);
      expect(retitled.cellMaxLines, original.cellMaxLines);
    });
  });
}
